...
public enum ErrorCode {
    ...
    WRONG_LOGIN_REQUEST(HttpStatus.BAD_REQUEST, "400", "비밀번호가 일치하지 않습니다."),
    ...
    NONE_MATCHED_MBTI(HttpStatus.BAD_REQUEST, "400", "유효하지 않은 MBTI 입니다."),
    ...
    /* REPORT */
    ALREADY_REPORTED(HttpStatus.BAD_REQUEST, "400", "이미 신고한 사용자 입니다."),
    CANNOT_REPORT_OWN_OPIN(HttpStatus.BAD_REQUEST, "400", "자신의 댓글은 신고할 수 없습니다."),
